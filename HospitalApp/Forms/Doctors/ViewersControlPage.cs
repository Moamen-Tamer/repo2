    ...
    public class ViewersControlPage: Panel
    {
        ...
        private void loadAdmissions()
        {
            ...
            try
            {
                ...
                string query = @"SELECT a.AdmissionID, p.Fullname, a.Status 
                                 FROM Admissions a
        ...
        private void loadViewers()
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    grid.Rows[rowIdx].Cells["Toggle"].Value = allowed ? "Suspend" : "Allow";
        ...
        private void allViewers(bool allowed)
        {
            ...
            try
            {
                ...
                string query = @"UPDATE ViewersList SET IsAllowed = @ia 
                                 WHERE AdmissionID = @aid";
        ...
        private void gridClick(Object? sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                ...
                string query = @"UPDATE ViewersList SET IsAllowed = @t 
                                 WHERE ViewerID = @vid";
